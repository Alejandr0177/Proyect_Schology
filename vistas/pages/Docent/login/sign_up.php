            ...
            <div class="login-box">
                ...
                <form method="post">
                    ...
                    <div class="input-group mb-3 ">
                        ...
                        <label class="bg-dark text-light input-group-text" >Titulo</label>
                        <select class="bg-dark text-info form-select" name="registroTitulo" required>
                            <option ></option>
                    ...
                    <div class="user-box">
                        ...
                        <input type="text" id="email" name="registroEmail" placeholder="            email@ugto.mx" required>
                        <label>Email</label>
                    ...
                    $registro = ControladorDocente::ctrRegistro();    
                    ...
                    echo '  <script>
                                    setTimeout(() => {
                                    window.location = "index.php?docentLogin=login";
                                    }, "1200");
                                </script>';
                    #==============================================================================
                    }
