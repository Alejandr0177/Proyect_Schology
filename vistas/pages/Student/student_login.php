...
<body>
    ...
    <div class="container-fluid Schology">
        ...
        <h3 class="text-center text-light py-3">Student</h3>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <ul class="nav nav-justified py-2 nav-pills">
                ...
                <?php
                include "vistas/pages/contenidos/c_student_login.php";
                ?>
    ...
    <div class="container-fluid">
        ...
        <div class="container py-5">
            ...
            if (isset($_GET["studentLogin"])) {
                ...
                if ($_GET["studentLogin"] == "sign_up" ||$_GET["studentLogin"] == "login"){

                    include "login/" . $_GET["studentLogin"] . ".php";
